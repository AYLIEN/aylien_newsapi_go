...
// HistogramApiService HistogramApi service
type HistogramApiService service
...
@return Histograms
*/
func (a *HistogramApiService) ListHistograms(ctx _context.Context, localVarOptionals *ListHistogramsOpts) (Histograms, *_nethttp.Response, error) {
	var (
