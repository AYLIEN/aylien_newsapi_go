...
// CoveragesApiService CoveragesApi service
type CoveragesApiService service
...
@return Coverages
*/
func (a *CoveragesApiService) ListCoverages(ctx _context.Context, localVarOptionals *ListCoveragesOpts) (Coverages, *_nethttp.Response, error) {
	var (
