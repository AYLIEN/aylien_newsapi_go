 ...
 * @param uNKNOWNBASETYPE /stories body schema to perform an advanced search with logical operators and nested objects. 
...
@return Stories
*/
func (a *DefaultApiService) AdvancedListStories(ctx _context.Context, uNKNOWNBASETYPE UNKNOWN_BASE_TYPE, localVarOptionals *AdvancedListStoriesOpts) (Stories, *_nethttp.Response, error) {
	var (
