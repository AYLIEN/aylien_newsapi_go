...
type ListHistogramsOpts struct {
    ...
    EntitiesId2 optional.Interface
    EntitiesLinksWikipedia optional.Interface
    EntitiesLinksWikipedia2 optional.Interface
    EntitiesLinksWikidata optional.Interface
    EntitiesLinksWikidata2 optional.Interface
    EntitiesTypes optional.Interface
    EntitiesTypes2 optional.Interface
    ...
    EntitiesSurfaceFormsText2 optional.Interface
    EntitiesTitleSurfaceFormsText optional.String
    EntitiesTitleSurfaceFormsText2 optional.Interface
    EntitiesBodySurfaceFormsText optional.Interface
    EntitiesBodySurfaceFormsText2 optional.Interface
 ...
 * @param "EntitiesId2" (optional.Interface of []string) -  This parameter is used to exclude stories based on the specified entity's `id`. You can read more about working with entities [here](https://newsapi.aylien.com/docs/working-with-entities). 
 ...
 * @param "EntitiesLinksWikipedia2" (optional.Interface of []string) -  This parameter is used to exclude stories based on the specified entity's Wikipedia URL. You can read more about working with entities [here](https://newsapi.aylien.com/docs/working-with-entities). 
 ...
 * @param "EntitiesLinksWikidata2" (optional.Interface of []string) -  This parameter is used to exclude stories based on the specified entity's Wikidata URL. You can read more about working with entities [here](https://newsapi.aylien.com/docs/working-with-entities). 
 ...
 * @param "EntitiesTypes2" (optional.Interface of []string) -  This parameter is used to exclude stories based on the specified entity's `types`. You can read more about working with entities [here](https://newsapi.aylien.com/docs/working-with-entities). 
 ...
 * @param "EntitiesSurfaceFormsText2" (optional.Interface of []string) -  This parameter is used to exclude stories based on the specified entity's `surface_form`. You can read more about working with entities [here](https://newsapi.aylien.com/docs/working-with-entities). 
 ...
 * @param "EntitiesTitleSurfaceFormsText2" (optional.Interface of []string) -  This parameter is used to exclude stories based on the specified entity's `surface_form` in story titles. You can read more about working with entities [here](https://newsapi.aylien.com/docs/working-with-entities). 
 ...
 * @param "EntitiesBodySurfaceFormsText2" (optional.Interface of []string) -  This parameter is used to exclude stories based on the specified entity's `surface_form` in the body of stories. You can read more about working with entities [here](https://newsapi.aylien.com/docs/working-with-entities). 
...
func (a *DefaultApiService) ListHistograms(ctx _context.Context, localVarOptionals *ListHistogramsOpts) (Histograms, *_nethttp.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.EntitiesId2.IsSet() {
		t:=localVarOptionals.EntitiesId2.Value()
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("!entities.id[]", parameterToString(s.Index(i), "multi"))
	...
	if localVarOptionals != nil && localVarOptionals.EntitiesLinksWikipedia2.IsSet() {
		t:=localVarOptionals.EntitiesLinksWikipedia2.Value()
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("!entities.links.wikipedia[]", parameterToString(s.Index(i), "multi"))
	...
	if localVarOptionals != nil && localVarOptionals.EntitiesLinksWikidata2.IsSet() {
		t:=localVarOptionals.EntitiesLinksWikidata2.Value()
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("!entities.links.wikidata[]", parameterToString(s.Index(i), "multi"))
	...
	if localVarOptionals != nil && localVarOptionals.EntitiesTypes2.IsSet() {
		t:=localVarOptionals.EntitiesTypes2.Value()
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("!entities.types[]", parameterToString(s.Index(i), "multi"))
	...
	if localVarOptionals != nil && localVarOptionals.EntitiesSurfaceFormsText2.IsSet() {
		t:=localVarOptionals.EntitiesSurfaceFormsText2.Value()
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("!entities.surface_forms.text[]", parameterToString(s.Index(i), "multi"))
	...
	if localVarOptionals != nil && localVarOptionals.EntitiesTitleSurfaceFormsText2.IsSet() {
		t:=localVarOptionals.EntitiesTitleSurfaceFormsText2.Value()
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
	...
	if localVarOptionals != nil && localVarOptionals.EntitiesBodySurfaceFormsText2.IsSet() {
		t:=localVarOptionals.EntitiesBodySurfaceFormsText2.Value()
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("!entities.body.surface_forms.text[]", parameterToString(s.Index(i), "multi"))
