...
// RelatedStoryApiService RelatedStoryApi service
type RelatedStoryApiService service
...
*/
func (a *RelatedStoryApiService) ListRelatedStoriesGet(ctx _context.Context, localVarOptionals *ListRelatedStoriesGetOpts) (RelatedStories, *_nethttp.Response, error) {
	var (
...
@return RelatedStories
*/
func (a *RelatedStoryApiService) ListRelatedStoriesPost(ctx _context.Context, localVarOptionals *ListRelatedStoriesPostOpts) (RelatedStories, *_nethttp.Response, error) {
	var (
