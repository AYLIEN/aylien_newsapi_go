...
// RelatedStoriesApiService RelatedStoriesApi service
type RelatedStoriesApiService service
...
*/
func (a *RelatedStoriesApiService) ListRelatedStories(ctx _context.Context, localVarOptionals *ListRelatedStoriesOpts) (RelatedStories, *_nethttp.Response, error) {
	var (
